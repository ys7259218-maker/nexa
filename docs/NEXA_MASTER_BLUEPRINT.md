...
| AI Employee card navigation baseline | ⚠️ | Manage actions use semantic protected-route links with standard keyboard/browser behavior; authenticated browser/device audits remain |
