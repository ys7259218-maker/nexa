...
| Dashboard record semantics baseline | ⚠️ | Stored call and appointment panels expose named sections, semantic lists, explicit empty states, and decorative icons; authenticated audits remain |
