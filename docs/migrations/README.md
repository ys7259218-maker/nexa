...
These migrations are manual and rollout-gated. Do not run this directory by filename order and do not apply it directly to production. The workspace foundation is currently the reviewed SQL block in `docs/SUPABASE_SETUP.md`; it must run before every file in this directory.
...
3. Apply **Workspace tenancy foundation** from `docs/SUPABASE_SETUP.md`.
4. Apply `20260824_workspace_tenancy_cutover.sql`.
