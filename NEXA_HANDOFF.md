...
- `npm run check` is green at the current PR #185 head (547 unit tests passing — PR #184's head was 541; PR #185 adds the six E.164 contract tests — enforced by `npm run check:documented-count` against the runner total at the same head; `npm audit` 0 vulnerabilities). Operational gates live in `docs/OPERATIONS_RUNBOOK.md`; go-live steps live in `docs/GO_LIVE.md`.
